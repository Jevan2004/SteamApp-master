  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const gameStats = {
        ...
        hours_played: Number(formData.hoursPlayed),
      ...
      setSuccessMessage("Game added successfully!" + (!isOnline ? " (Will sync when online)" : ""));
  ...
  return (
    <div className="container">
      <div className="form-container">
        ...
        {!isOnline && <div className="offline-banner">You are currently offline. Changes will sync when you're back online.</div>}
